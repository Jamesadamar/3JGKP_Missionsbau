...
[] spawn {
	...
	(findDisplay 46) displayAddEventHandler [
		"KeyDown", 
		{
			...
			if (_key == 41 && _shift && isNull (findDisplay 3100)) then {
...
JGKP_DC_access_level = [
	...
	[
		...
		"Reguläres Mitglied",
		[
			1400, 1600, 1601, 1402, 1602, 1603, 1404, 1604, 1605, 1406, 1606, 1607, 1408, 2100, 1608, 1609, 1610, 1611, 1612, 1614, 1615, 1616, 1617, 1618, 1619, 1624, 1625, 1626, 1627
		],
	...
	[
		...
		"Missionsbauer",
		[
			1408, 2100, 1608, 1609, 1610, 1611, 1612, 1615, 1616, 1618, 1619, 1624, 1625, 1626, 1627
		],
	...
	[
		...
		"Zugführer",
		[
			2100, 1408, 1608, 1609, 1610, 1611, 1612, 1626, 1627
		],
