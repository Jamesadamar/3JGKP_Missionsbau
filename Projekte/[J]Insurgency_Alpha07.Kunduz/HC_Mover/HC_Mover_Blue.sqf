...
//
//
//Verschiebt alle 83 sec. alle Bluefor-KI-Infanterie Einheiten auf den HC
...
while {true} do
{
    ...
    [[_MoverCount,"Bluefor Gruppen auf HC verschoben."],"COY_Fnc_MP_Debug"] spawn BIS_fnc_MP;//Debug Einblendung
