...
If ((getPlayerUID player)=="_SP_PLAYER_") then {UPSMON_Debug = 1;} else {UPSMON_Debug = 0;};
...
// Name of the Headless Client to monitor (name of the HC Modul!)
UPSMON_HC = "headlessclient";
...
UPSMON = compile preProcessFileLineNumbers "modules\Upsmon\UPSMON.sqf";
UPSMON_CreateGroup = compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\UPSMON_CreateGroup.sqf";

//Core
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\Core\init.sqf";
call compile preprocessFileLineNumbers "modules\Upsmon\UPSMON\Get_pos\UPSMON_pos_init.sqf";
//Params
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\Group\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\target\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\unit\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\Params\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\buildings\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\vehicles\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\cover\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\terrain\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\COMMON\MP\init.sqf";
//Modules
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\FORTIFY\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\AMBUSH\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ARTILLERY\init.sqf";
//Orders
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ORDERS\UPSMON_PATROL\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ORDERS\UPSMON_REINFORCEMENT\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ORDERS\UPSMON_Transport\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ORDERS\UPSMON_PATROLSRCH\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ORDERS\UPSMON_FLANK\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ORDERS\UPSMON_ASSAULT\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ORDERS\UPSMON_DEFEND\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ORDERS\UPSMON_RELAX\init.sqf";
call compile preProcessFileLineNumbers "modules\Upsmon\UPSMON\MODULES\ORDERS\UPSMON_SUPPLY\init.sqf";

[] execvm "modules\Upsmon\UPSMON\COMMON\CORE\fnc\UPSMON_TRACK.sqf";
[] execvm "modules\Upsmon\UPSMON\UPSMON_MAINLOOP.sqf";
[] execvm "modules\Upsmon\UPSMON\UPSMON_MAINLOOPCiv.sqf";
...
///////////////////////////////////////////////////////////////////////////////////////////
// Initialise the Headless Client fail-safe solution
///////////////////////////////////////////////////////////////////////////////////////////
if(isServer)then{
	[] execvm "modules\Upsmon\UPSMON\MODULES\HC_FAIL_SAFE\initServer.sqf";
};
if(!hasInterface && !isServer)then{
	[] execvm "modules\Upsmon\UPSMON\MODULES\HC_FAIL_SAFE\initHC.sqf";
};
