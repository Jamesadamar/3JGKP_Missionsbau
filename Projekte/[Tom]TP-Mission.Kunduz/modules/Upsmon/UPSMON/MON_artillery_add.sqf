/*  =====================================================================================================
 ...
 =====================================================================================================		
	Parámeters: [_artillery,(_rounds,_area,_cadence,_mincadence)] execvm "modules\Upsmon\UPSMON\MON_artillery_add.sqf";	
 ...
 =====================================================================================================
	...
	2. Exec module in int of static weapon
		...
		nul=[this] execVM "modules\Upsmon\UPSMON\MON_artillery_add.sqf";
