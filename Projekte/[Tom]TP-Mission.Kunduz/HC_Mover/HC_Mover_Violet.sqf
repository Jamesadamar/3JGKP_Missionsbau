...
//
//
//Verschiebt alle 97 sec. alle Zivilen-KI-Infanterie Einheiten auf den HC
...
while {true} do
{
    ...
    [[_MoverCount,"Zivile Gruppen auf HC verschoben."],"COY_Fnc_MP_Debug"] spawn BIS_fnc_MP;//Debug Einblendung
