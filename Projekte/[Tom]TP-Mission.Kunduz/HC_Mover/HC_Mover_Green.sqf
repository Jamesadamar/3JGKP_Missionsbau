...
//
//
//Verschiebt alle 71 sec. alle Resistance-KI-Infanterie Einheiten auf den HC
...
while {true} do
{
    ...
    [[_MoverCount,"Resistance Gruppen auf HC verschoben."],"COY_Fnc_MP_Debug"] spawn BIS_fnc_MP;//Debug Einblendung
